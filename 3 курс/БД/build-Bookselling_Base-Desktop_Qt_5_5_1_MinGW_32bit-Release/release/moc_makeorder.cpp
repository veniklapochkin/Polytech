...
#include "../../Bookselling_Base/makeorder.h"
...
QT_MOC_LITERAL(3, 33, 29), // "on_product_currentTextChanged"
QT_MOC_LITERAL(4, 63, 4) // "arg1"

    },
    "makeorder\0on_pushButton_clicked\0\0"
    "on_product_currentTextChanged\0arg1"
};
...
void makeorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_product_currentTextChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject makeorder::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_makeorder.data,
      qt_meta_data_makeorder,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *makeorder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_makeorder.stringdata0))
        return static_cast<void*>(const_cast< makeorder*>(this));
