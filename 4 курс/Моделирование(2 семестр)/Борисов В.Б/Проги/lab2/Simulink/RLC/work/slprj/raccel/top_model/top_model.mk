...
MODEL               = top_model
MODULES             = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c top_model_capi.c top_model_data.c top_model_tgtconn.c 
MAKEFILE            = top_model.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/venik/OneDrive/Документы/MATLAB/projects/RLC/work
S_FUNCTIONS         = rtiostream_utils.c sfun_spssw_contc.c
...
MODELLIB                  = top_modellib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = top_model_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/top_model \
	-I$(START_DIR) \
	-IC:/Users/venik/OneDrive/Документы/MATLAB/projects/RLC/models \
...
MAT_LIBS = $(LIBUT) $(LIBMX) $(LIBMEX) $(LIBMAT) $(LIBMWMATHUTIL) $(LIBSL_FILEIO) $(LIBSIGSTREAM)
